  ...
  return (
    <>
      ...
      <section className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 md:py-20">
        ...
        <div id="booking-form" className="mt-8 rounded-xl border border-zinc-800 bg-zinc-900 p-6">
          <h3 className="text-lg font-semibold text-yellow-400">{t('contact.formTitle')}</h3>
          <p className="mt-2 text-sm text-zinc-300">{t('contact.formSubtitle')}</p>
          <form className="mt-5 grid gap-4 sm:grid-cols-2">
            <label className="text-sm text-zinc-300">
              <span className="mb-1 block">{t('contact.nameLabel')}</span>
              <input
                type="text"
                className="w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2 text-zinc-100 outline-none transition focus:border-yellow-400"
              />
            </label>
            <label className="text-sm text-zinc-300">
              <span className="mb-1 block">{t('contact.phoneLabel')}</span>
              <input
                type="tel"
                className="w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2 text-zinc-100 outline-none transition focus:border-yellow-400"
              />
            ...
            <label className="text-sm text-zinc-300">
              <span className="mb-1 block">{t('contact.pickupLabel')}</span>
              <input
                type="text"
                className="w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2 text-zinc-100 outline-none transition focus:border-yellow-400"
              />
            ...
            <label className="text-sm text-zinc-300">
              <span className="mb-1 block">{t('contact.destinationLabel')}</span>
              <input
                type="text"
                className="w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2 text-zinc-100 outline-none transition focus:border-yellow-400"
              />
            ...
            <label className="sm:col-span-2 text-sm text-zinc-300">
              <span className="mb-1 block">{t('contact.messageLabel')}</span>
              <textarea
                rows="4"
